...
class ProtocolSpec extends FlatSpec {
  ignore should "Protocol parse blochain blocks" in {
  ...
  ignore should "serialize/deserialize blocks" in {
    val stream = classOf[ProtocolSpec].getResourceAsStream("/block1.dat")
  ...
  ignore should "decode transactions" in {
    // data copied from https://people.xiph.org/~greg/signdemo.txt
    val tx = Transaction.read("0100000076176264010c432f4fb3e871a8bda638350b3d5c698cf431db8d6031b53e3fb5159e59d4a90000000000ffffffff0100f2052a010000001976a9143744841e13b90b4aca16fe793a7f88da3a23cc7188ac00000000")
  ...
  it should "generate genesis block" in {
    assert(Block.write(Block.LivenetGenesisBlock) === hex"")
  ...
  ignore should "read and write block messages" in {
