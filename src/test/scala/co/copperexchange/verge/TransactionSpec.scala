...
class TransactionSpec extends FunSuite with Matchers {
  ...
  test("read and write transactions") {
    val hex = hex""
    val tx = Transaction.read(hex.toArray)
    assert(tx.bin === hex)
  }

  test("read transaction without inputs in non-witness format") {
    val hex = hex"02000000761762640002d3dff505000000001976a914d0c59903c5bac2868760e90fd521a4665aa7652088ac00e1f5050000000017a9143545e6e33b832c47050f24d3eeb93c9c03948bc787b32e1300"
    ...
    assert(tx.txid === ByteVector32(hex"29fb4e6f97e33a66f1fc683af3bb296fb9dfc05eebab8767abd9fa13e1fa51d1"))
  ...
  test("create and verify pay2pk transactions with 1 input/1 output") {
    ...
    val previousTx = Transaction.read("")
  ...
  test("create and verify sign pay2pk transactions with multiple inputs and outputs") {
    ...
    val time: Long = 1684150134

    val previousTx = List(
      Transaction.read(""),
      Transaction.read("")
    )
    ...
    assert(tx1.toString == "")
  ...
  test("create and sign p2sh transactions") {
    ...
    val previousTx = Transaction.read("")
  ...
  test("sign a 3-to-2 transaction with helper method") {
    ...
    val previousTx = List(
      Transaction.read(""),
      Transaction.read(""),
      Transaction.read("")
    )
    ...
    assert(signedTx.toString == "")
  ...
  test("compute tx size and weight") {
    val tx = Transaction.read("")

    assert(tx.baseSize() == 218)
    assert(tx.totalSize() == 440)
    assert(tx.weight() == 1094)
  }

  test("compute toString (segwit tx") {
    val hex = ""
